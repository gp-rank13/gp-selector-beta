...
// List of menu items
const std::vector<std::string> menuNames = { "Show Selector", "Toggle Zero-Based Numbers", "Toggle Immediate Switching", "Toggle Large Scroll Area", "Toggle Thick Borders", "Toggle Lock to Setlist Mode"};
