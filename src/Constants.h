...
// List of menu items
const std::vector<std::string> menuNames = { "Show Selector", "Toggle Zero-Based Numbers", "Toggle Immediate Switching", "Toggle Large Scroll Area", "Toggle Thick Borders", "Toggle Variations in Setlist Mode", "Toggle Lock to Setlist Mode"};
...
const juce::String HEADER_SONG_COLOR = "FF894B28";
